...
public class DrawingShapesAndColorsNoResetApplet extends Applet {
	...
	//Now we removed the color reset, and the string "Shapes and Colors" should be yellow after minimizing the browser!
	g.setFont(smallFont);
	g.drawString("Try minimizing and maximizing the browser",10,250);
	g.drawString("to see the effect of not resetting the color!",10,270);
